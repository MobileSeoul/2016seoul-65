...
public class ScheduleAdapter extends BaseAdapter {
    ...
    public ScheduleAdapter( Context context, ArrayList<ScheduleInfo> data ) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if( v == null ) {
            ...
            v = inflater.inflate( R.layout.schedule_listitem, null );

            info.startDate = (TextView)v.findViewById( R.id.home_today_time );
            info.startDate.setText((listData.get(position).s_smonth)+"."+(listData.get(position).s_sday));
            info.title = (TextView)v.findViewById( R.id.home_today_plan );
            info.title.setText(listData.get( position ).stitle );
            info.location = (TextView)v.findViewById( R.id.home_today_location );
            //info.location.setText( listData.get( position ).local );
            info.location.setText("의정부동");
